            ...
            <MDBRow>
              ...
              <MDBCol md='6' >
                ...
                <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
                  ...
                  <a className='btn btn-primary mb-4 px-5 mx-5 w-100' style={{ fontSize: '15px' }} href={"https://back-end-e-commerce-production-85fa.up.railway.app/login-google"}><i class="fab fa-google me-2"></i> Sign in with google</a>
